...
//                   <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-purple-600 to-pink-600 rounded-full mb-4 group-hover:shadow-2xl transition-shadow duration-300">
...
//                   <div>
//                     <h4 className="font-bold text-lg mb-6 text-white">Popular Courses</h4>
...
//                       A,B, gopalsamy, 140, Gopalasamy Koil St, Sridevi Nagar, Ganapathy
