...
const CustomArrow = ({ direction, onClick }) => (
  <button
    className={`absolute top-1/2 -translate-y-1/2 z-10 w-16 h-16 rounded-full bg-white/20 backdrop-blur-sm border border-white/30 flex items-center justify-center text-white hover:bg-white/30 hover:scale-110 transition-all duration-300 shadow-2xl ${
...
const FeaturedCoursesSection = () => (
  <section className="relative min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 flex flex-col justify-center items-center px-4 py-20" id="services">
    ...
    <div className="w-64 sm:w-full max-w-2xl mx-auto relative">
      <Carousel 
        autoplay 
        dots
        arrows
